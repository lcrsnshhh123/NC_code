...
GTDLL_API GT_CtrlMode(unsigned short mode);
...
GTDLL_API GT_GetILmt(unsigned short *limit);
GTDLL_API GT_GetIntgr(short *integral);
GTDLL_API GT_GetJerk(double *jerk);
GTDLL_API GT_GetKaff(unsigned short *kaff);
GTDLL_API GT_GetKd(unsigned short *kd);
GTDLL_API GT_GetKi(unsigned short *ki);
GTDLL_API GT_GetKp(unsigned short *kp);
GTDLL_API GT_GetKvff(unsigned short *kvff);
...
GTDLL_API GT_GetMtrBias(short *bias);
GTDLL_API GT_GetMtrCmd(short *voltage);
GTDLL_API GT_GetMtrLmt(unsigned short *limit);
GTDLL_API GT_GetPos(long *pos);
GTDLL_API GT_GetPosErr(unsigned short *limit);
...
GTDLL_API GT_SetILmt(unsigned short limit);
GTDLL_API GT_SetJerk(double jerk);
GTDLL_API GT_SetKaff(unsigned short kaff);
GTDLL_API GT_SetKaffEx(double kaff);
GTDLL_API GT_SetKd(unsigned short kd);
GTDLL_API GT_SetKdEx(double kd);
GTDLL_API GT_SetKi(unsigned short ki);
GTDLL_API GT_SetKiEx(double ki);
GTDLL_API GT_SetKp(unsigned short kp);
GTDLL_API GT_SetKpEx(double kp);
GTDLL_API GT_SetKvff(unsigned short kvff);
GTDLL_API GT_SetKvffEx(double kvff);
GTDLL_API GT_SetMAcc(double acc);
GTDLL_API GT_SetMtrBias(short bias);
GTDLL_API GT_SetMtrCmd(short voltage);
GTDLL_API GT_SetMtrLmt(unsigned short limit);
GTDLL_API GT_SetPos(long pos);
GTDLL_API GT_SetPosErr(unsigned short limit);
